...
.. table::
   ...
   | Log Source                                           | Score |
   +======================================================+=======+
   | EDR: Credential Dumping / LSASS Access               | 26.5  |
   +------------------------------------------------------+-------+
   | Sysmon: EID 10: Process Access (LSASS)               | 26.5  |
   +------------------------------------------------------+-------+
   | Azure AD Identity Protection Alerts                  | 26.4  |
   +------------------------------------------------------+-------+
   | EDR: API Calls (LSARetrievePrivateData, etc.)        | 25.8  |
   +------------------------------------------------------+-------+
   | EDR: Auth w/ NTLM/Pass-the-Hash                      | 25.6  |
   +------------------------------------------------------+-------+
   | EDR: Browser Credential Store Access                 | 24.8  |
   +------------------------------------------------------+-------+
   | Sysmon: EID 1: Process Create                        | 24.2  |
   +------------------------------------------------------+-------+
   | Windows Security: EID 4738, 4732                     | 23.8  |
   +------------------------------------------------------+-------+
   | Cloud Provider Logs (Anomalous Token Use)            | 23.1  |
   +------------------------------------------------------+-------+
   | Windows Security: EID 4688: Process Creation         | 22.7  |
   +------------------------------------------------------+-------+
