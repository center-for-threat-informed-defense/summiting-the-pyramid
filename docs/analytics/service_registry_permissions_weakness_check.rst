...
Setting a Security Access Control List (SACL) on the registry key allows us to use a kernel-level sensor for the same operation. This logs what the script is 
